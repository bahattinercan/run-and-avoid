namespace Assets.Scripts.Water
{
    ...
    {
        [SerializeField] private List<Renderer> waterRenderers;
        ...
        public void Awake()
        {
            ...
            waterRenderers.Add(GameObject.Find("WaterPlane").GetComponent<Renderer>());
            GameObject[] inWaterObjects = GameObject.FindGameObjectsWithTag("InWaterObject");
            foreach (GameObject inWaterObject in inWaterObjects)
            {
                waterRenderers.Add(inWaterObject.GetComponent<Renderer>());
            }
